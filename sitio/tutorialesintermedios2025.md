...
| --- | --- | --- | --- | --- | --- | --- |
| 13 [Video](https://www.youtube.com/watch?v=TSJoxcOjxwM) <br><br><code style="color : darkorange"># **R**</code> <br><br>**Sesión de dudas R**<br><br>Jorge | 14 [Video](https://www.youtube.com/watch?v=jHRalpBoYOo)<br><br><code style="color : darkorange"># **Python**</code> <br><br>**Sesión de dudas Python**<br><br>Julia | 15<br><br>TRABAJO | 16<br><br>AUTÓNOMO | 17<br><br>(Evaluación) |     |     |
| --- | --- | --- | --- | --- | --- | --- |
